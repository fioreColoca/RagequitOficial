                            ...
                            <div class="row mb-4">
                                ...
                                <div class="container col-md-10 col-lg-11 justify-content-center">
                                    ...
                                    <c:if test="${estadoComentario=='ACTIVO'}">
                                        ...
                                        <p>En respuesta a: X publicaci�n</p>
                                        ...
                                        <c:if test="${not empty usuarioRol}">
                                            <div class="hoverIcons d-flex justify-content-around bg-fondo p-2">
                                                <form action="meGustaComentario">
                                                    <div>
                                                        <button class="btn btn-outline-naranja" value="${comentario.getId()}" name="botonLike">
                                                            <i class="far fa-thumbs-up"></i>
                                                        </button>
                                                        <a class="verListadoLikes" data-toggle="modal" href="#verListado" data-id="${comentario.getId()}">
                                                            ${comentario.getCantidadLikes()}</a>
                                                    </div>
                                                </form>
                                                <div class="ml-3">
                                                    <button type="button" class="btn btn-outline-naranja responderComentario" data-toggle="modal" data-target="#responderComentario" data-id="${comentario.getId()}">
                                                ...
                                                <c:if test="${idUsuario == IdUsuarioComentario}">
                                                    <form action="borrarComentario">
                                                        <div>
                                                            <button type="button" class="btn btn-outline-naranja botonBorrar" data-toggle="modal" data-target="#borrarComentario" data-id="${comentario.getId()}">
                                            ...
                                            <c:if test="${estadoRespuesta=='ACTIVO'}">
                                                ...
                                                <c:if test="${not empty usuarioRol}">
                                                    <div class="hoverIcons d-flex justify-content-around bg-fondo p-2">
                                                        <form action="meGustaComentario">
                                                            <div>
                                                                <button class="btn btn-outline-naranja" value="${respuesta.getId()}" name="botonLike">
                                                                    <i class="far fa-thumbs-up"></i>
                                                                </button>
                                                                <a class="verListadoLikes" data-toggle="modal" href="#verListado" data-id="${comentario.getId()}">
                                                        ...
                                                        <c:if test="${idUsuario == IdUsuarioRespuesta}">
                                                            <form action="borrarComentario">
                                                                <div>
                                                                    <button type="button" class="btn btn-outline-naranja botonBorrar" data-toggle="modal" data-target="#borrarComentario" data-id="${respuesta.getId()}">
                                                                        <i class="far fa-trash-alt"></i>
                                                                    </button>
                                                                </div>
                                                            </form>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-fondo p-3">
                        <form action="responderComentario" class="container" method="GET">
                            <p>Respondiendo a</p>
                            <div>
                                <textarea id="respuestaMandar" name="respuestaMandar" class="form-control" rows="3" placeholder="Escribe tu respuesta" required></textarea>
                            </div>
                            ...
                            <div class="row responderComent" id="">
                                ...
                                <div class="col-6 mt-6 mb-3">
                                    ...
                                    <button type="submit" class="btn btn-naranja" name="boton" value="comun">Responder</button>
                                </div>
