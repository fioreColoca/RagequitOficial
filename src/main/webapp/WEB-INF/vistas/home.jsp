<%@ include file="header.jsp"%>
        ...
        <p>
            <a class="btn btn-warning" data-toggle="collapse" href="#collapseExample" role="button"
                ...
                Presione aquí para mas información...
            </a>

        </p>
        <div class="collapse" id="collapseExample">
            <div class="card card-body info">
                Bienvenido a la página oficial de RageQuit, en estos momentos la página se encuentra en construcción.
                Pero puede repasar a examinar nuestras diferentes areas. Saludos, comisión directiva de RageQuit. 
