          ...
          <main>
            <section>
                    <p>
                        ...
                        Presione aqui para mas informacion...
                    </a>

                    </p>
                <div class="collapse" id="collapseExample">
                    <div class="card card-body info">
                        Bienvenido a la pagina oficial de RageQuit, en estos momentos la pagina se encuentra en consturccion. Pero puede repasar a examinar nuestras direfentes areas. Saludos, comision directiva de RageQuit.
