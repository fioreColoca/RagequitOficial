<c:if test="${not empty comentarios}">
	<div class="collapse"
		id="collapseComentario${publicacionDelFor.getId()}">
		<c:forEach items="${comentarios}" var="comentario">
			<c:if
				test="${comentario.getPublicacion().getId() == publicacionDelFor.getId()}">
				<div
					class="container p-3 bg-fondo border border-top-0 
					...
					<div class="row mb-4">
						<div
							...
							<img class="rounded-circle border border-dark"
								src="${comentario.getUsuario().getUrl_imagen()}" width="50"
								height="50">
						</div>
				...
				<div class="ml-5 collapse"
					id="collapseRespuesta${comentario.getId()}">
								...
								<div class="row mb-4">
									...
									<div
										...
										<c:if test="${estadoRespuesta=='ACTIVO'}">
											...
											<p>En respuesta a:
												${respuestaRespuesta.getUsuario().getNombreUsuario()}</p>
