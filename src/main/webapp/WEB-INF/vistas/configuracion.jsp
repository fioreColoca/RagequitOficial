        ...
        <section class="ancho p-3 row">
            ...
            <article class="col-12 col-md-9 pt-4">
                <div class="row border-bottom">
                    ...
                    <h5 class="col-4 text-right">
                        <button type="button" class="btn btn-outline-info" data-toggle="modal"
                            data-target="#cambiarNombre" href="#">
                            Editar</button>
                    </h5>
                ...
                <div class="row mt-2 border-bottom">
                    ...
                    <h5 class="col-4 text-right">
                        <button type="button" class="btn btn-outline-info" data-toggle="modal"
                            data-target="#cambiarApellido" href="#">
                            Editar</button>
                    </h5>
                    <div class="modal fade" id="cambiarApellido" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-dark text-white">
                ...
                <div class="row mt-2 border-bottom">
                    ...
                    <h5 class="col-4 text-right">
                        <button type="button" class="btn btn-outline-info" data-toggle="modal"
                            data-target="#cambiarEmail" href="#">
                            Editar</button>
                    </h5>
                    <div class="modal fade" id="cambiarEmail" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-dark text-white">
                ...
                <div class="row mt-2 border-bottom">
                    ...
                    <h5 class="col-4 text-right">
                        <button type="button" class="btn btn-outline-info" data-toggle="modal"
                            data-target="#cambiarNombreUsuario" href="#">
                            Editar</button>
                    </h5>
                    <div class="modal fade" id="cambiarNombreUsuario" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-dark text-white">
    ...
    <c:if test="${ empty usuarioLogeado}">
        <div id="notfound" style="margin: -1em">
            <div class="notfound">
                ...
                <p>Es posible que la página que está buscando se haya eliminado, no está disponible temporalmente o no
                    tienes acceso a ella.</p>
