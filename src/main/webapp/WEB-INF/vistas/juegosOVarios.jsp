...
<main>
	<section class="row">
		<article class="col-12 col-md-3"
			style="width: fit-content; background-color: #04233b; padding: 2% 4.5% 2% 4.5%;">
			<img class="imagenBiblioteca text-center borde-naranja"
				style="margin-bottom: 5%;" src="${juegosOVarios.getUrlImagen()}">

			<a class="link-seguidos" data-toggle="modal"
				data-target="#seguidores">
				<h5 class="text-secondary ">Seguidores:
					${juegosOVarios.getContadorSeguidores()}</h5>
			</a>
		...
		<article class="col-12 col-md-9 p-4"
			style="background-color: #04233b; border-left-style: solid; border-left-color: #0A4573;">
			...
			<c:if test="${not empty usuarioLogeado}">
				...
				<form class="" action="crearCriticaCategoria" method="POST">
					<div class="form-group">
						<input class="col-12 form-control" name="usuarioCritico"
							type="hidden" value="${usuarioLogeado.getId()}" /> <input
							class="col-12 form-control" name="categoria" type="hidden"
							value="${juegosOVarios.getId()}" />
					</div>
					<div class="form-group">
						<p class="clasificacion">
							...
							<label for="radio1"><i class="fas fa-star"></i></label> <input
								id="radio2" type="radio" name="calificacion" value="4">

							<label for="radio2"><i class="fas fa-star"></i></label> <input
								id="radio3" type="radio" name="calificacion" value="3">

							<label for="radio3"><i class="fas fa-star"></i></label> <input
								id="radio4" type="radio" name="calificacion" value="2">

							<label for="radio4"><i class="fas fa-star"></i></label> <input
								id="radio5" type="radio" name="calificacion" value="1">
					...
					<div class="form-group">
						...
						<button class="btn btn-info btn-block"
							style="background-color: #f4a117; border-color: #04233b;">Crear
							Critica</button>
					</div>
				</form>
			</c:if>
