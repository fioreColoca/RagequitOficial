...
<main>
	<section class="row">
		<article class="col-12 col-md-3" style="width: fit-content; background-color: #04233b; padding: 2% 4.5% 2% 4.5%;">
			<img class="imagenBiblioteca text-center borde-naranja" style="margin-bottom: 5%;"
				src="${juegosOVarios.getUrlImagen()}">
				
				<a class="link-seguidos" data-toggle="modal"
				data-target="#seguidores">
				<h5 class="text-secondary ">Seguidores: ${juegosOVarios.getContadorSeguidores()}</h5>
			</a>
