...
<body>
    <header>
        <nav class="navbar navbar-expand-xl navbar-dark bg-dark">
            ...
            <img src="img/Logo-RageQuitPNG.png" alt="Logo" class="logo">
                ...
                <div class="navbar-nav ml-auto">
                    <div class="nav-item dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-item nav-link dropdown-toggle user-action"><img
                                ...
                                alt="Avatar"> Santiago Fagliano <b class="caret"></b></a>
                        <div class="dropdown-menu">
                            <a href="#" class="dropdown-item"><i class="fa fa-user-o"></i> Perfil</a>
                            <a href="#" class="dropdown-item"><i class="fa fa-calendar-o"></i> Calendario</a>
                            <a href="#" class="dropdown-item"><i class="fa fa-sliders"></i> Configuracion</a>
                            <div class="divider dropdown-divider"></div>
                            <a href="#" class="dropdown-item"><i class="material-icons">&#xE8AC;</i> Cerrar
                                sesi&oacute;n</a>
                        </div>
                    </div>
                    ...
                    <a href="#" class="nav-item nav-link"><i class="fa fa-briefcase"></i><span>Publicacion</span></a>
