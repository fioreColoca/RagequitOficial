...
public class HomeTest {
	...
	/*
	 * @Test public void testDeQueSiUnaPublicacionNoTieneCategoriaTiraError() {
	 * 
	 * when(publicacionMock.getCategoriaId()).thenReturn(-1L);
	 * when(publicacionMock.getMensaje()).thenReturn("No vacio");
	 * 
	 * ModelAndView modelAndView =
	 * controladorPublicacion.guardarPublicacion(publicacionMock, requestMock);
	 * 
	 * 
	 * assertThat(modelAndView.getViewName()).
	 * isEqualTo("redirect:/home?errorMensaje=null&errorCategoria=Falta elegir categoria"
	 * ); }
	 * 
	 * @Test public void testDeQueSiUnaPublicacionNoTieneMensajeTiraError() {
	 * 
	 * when(publicacionMock.getCategoriaId()).thenReturn(1L);
	 * when(servicioCategoriaMock.mostrarCategoriaPorId(1L)).thenReturn(
	 * categoriaMock);
	 * when(repositorioCategoriaMock.mostrarCategoriaPorId(1L)).thenReturn(
	 * categoriaMock); when(publicacionMock.getMensaje()).thenReturn("");
	 * 
	 ...
	 * 
	 * assertThat(modelAndView.getViewName()).
	 * isEqualTo("redirect:/home?errorMensaje=La publicacion no puede tener un mensaje vacio&errorCategoria=null"
	 * ); }
	 * 
	 * @Test public void
	 * testDeQueSiUnaPublicacionTieneMensajeYCategoriaNoTireError() {
	 * 
	 * when(publicacionMock.getCategoriaId()).thenReturn(1L);
	 * when(servicioCategoriaMock.mostrarCategoriaPorId(1L)).thenReturn(
	 * categoriaMock); when(publicacionMock.getMensaje()).thenReturn("Mensaje");
	 * 
	 * controladorPublicacion.setServicioCategoria(servicioCategoriaMock);
	 ...
	 * "redirect:/home?errorMensaje=null&errorCategoria=null"); }
	 */
}
