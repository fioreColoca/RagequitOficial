...
value(1, "Paladins es una curiosa mezcla de acción en primera persona de carácter competitivo y estrategia de manos de los creadores de Smite que, con formato free-to-play (gratuito), ofrece un interesante acercamiento con pinceladas de táctica y rol.", "Paladins", 0, "img/categoriaIcon/paladinsIcon.png", "https://static-cdn.jtvnw.net/ttv-boxart/Paladins-144x192.jpg"),
(2, "Se utiliza con frecuencia para demostrar que algo te parece muy lindo o quieres expresar ternura, esto de acuerdo con el Urban Dictionary. Otra forma de decirlo es que se utiliza 'uwu' cuando algo es sumamente kawaii. Por su parte, Internet Slang define a 'uwu' como 'cara de anime feliz'.", "UWU", 1,"img/categoriaIcon/uwuIcon.png","https://wallpaperaccess.com/full/2108555.jpg"),
(3, "Las siglas 'Lol' corresponden a las iniciales del popular videojuego 'League of Legends', un juego online que cuenta con gran cantidad de seguidores desde que se lanzara en 2009. El objetivo de los jugadores de 'Lol' es proteger la base propia mientras en el mapa se localizan y destruyen las bases de los enemigos.", "LoL", 0,"img/categoriaIcon/leagueOfLegendsIcon.png", "https://static-cdn.jtvnw.net/ttv-boxart/League%20of%20Legends-144x192.jpg"),
...
(6, "El juego se basa en dos equipos, cada uno formado por cinco dioses, enfrentados en un campo de batalla con la finalidad de destruir el titán enemigo situado en cada una de las bases. Cada jugador se pone en la piel de un dios de diferentes mitologías el cual posee distintos poderes y características.", "Smite",0, "img/categoriaIcon/smiteIcon.png", "https://static-cdn.jtvnw.net/ttv-boxart/SMITE-144x192.jpg"),
...
(8, "Garena Free Fire es un juego de battle royal de acción y aventuras solo en línea que se juega en una perspectiva en tercera persona. El juego consta de hasta 50 jugadores que caen de un paracaídas en una isla en busca de armas y equipo para matar a los demás jugadores. El último jugador o equipo en pie gana la ronda.", "FreeFire",0, "img/categoriaIcon/freeFireIcon.png", "https://static-cdn.jtvnw.net/ttv-boxart/Garena%20Free%20Fire-144x192.jpg"),
...
(11, "Old School RuneScape (a veces llamado 2007scape) es el nombre oficial de Jagex para una versión antigua de RuneScape que han introducidos de un backup del código fuente de RuneScape del 10 de agosto, 2007. Esta versión del juego fue anunciada el 13 de febrero de 2013.", "Old School RuneScape",0, "img/categoriaIcon/oldSchoolRunEscapeIcon.png", "https://static-cdn.jtvnw.net/ttv-boxart/Old%20School%20RuneScape-144x192.jpg"),
